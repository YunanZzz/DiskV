...
void write_index(const Index* idx, IOWriter* f, int io_flags) {
    if (idx == nullptr) {
        ...
        //     }
        //     WRITE1(ivfpqd->top);
        //     WRITE1(ivfpqd->estimate_factor);
        //     WRITE1(ivfpqd->estimate_factor_partial);
        //     WRITE1(ivfpqd->prune_factor);
        //     WRITE1(ivfpqd->disk_vector_offset);
        ...
        //     for (size_t i = 0; i < nlist; ++i) {
        //         WRITE1(ivfpqfsd->clusters[i]);
        //     }
        //     for (size_t i = 0; i < nlist; ++i) {
        //         WRITE1(ivfpqfsd->len[i]);
        //     }
        //     WRITE1(ivfpqfsd->top);
        //     WRITE1(ivfpqfsd->estimate_factor);
        //     WRITE1(ivfpqfsd->estimate_factor_partial);
        //     WRITE1(ivfpqfsd->prune_factor);
        //     WRITE1(ivfpqfsd->disk_vector_offset);
        //     WRITE1(ivfpqfsd->assign_replicas);

        //     size_t path_length = ivfpqfsd->disk_path.size();
        //     WRITE1(path_length); 
        //     WRITEANDCHECK(ivfpqfsd->disk_path.c_str(), path_length);
        // } 
    } else if (
